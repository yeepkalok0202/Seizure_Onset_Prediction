...
TUNABLE_CONV_KERNEL_SIZE = [10]  # Example: Added another kernel size
TUNABLE_POOL_SIZE = [2]  # Example: Added another pool size
TUNABLE_LSTM_UNITS = [128]  # Example: Added another LSTM unit size
TUNABLE_DENSE_UNITS = [64]  # Example: Added another Dense unit size
